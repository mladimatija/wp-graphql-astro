 ...
 */
export function transitionName(name: string, id?: string | number): {style: string} {
  return {
 ...
 */
export function pageTransition(element: string, id?: string | number): {style: string} {
 ...
 */
export function getTransitionClasses(baseClasses: string, transitionType?: string): string {
