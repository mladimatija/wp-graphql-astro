 ...
 */
export async function getSiteConfig(): Promise<CollectionEntry<'config'> | undefined> {
 ...
 */
export async function getComponentsByTemplate(template: string): Promise<CollectionEntry<'components'>[]> {
  const components = await getCollection('components');
  return components
 ...
 */
export async function getPageBySlug(slug: string): Promise<CollectionEntry<'pages'> | undefined> {
 ...
 */
export async function getAuthorBySlug(slug: string): Promise<CollectionEntry<'authors'> | undefined> {
