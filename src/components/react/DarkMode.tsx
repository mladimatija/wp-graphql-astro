...
export default function DarkMode(): React.ReactElement | null {
    ...
    useEffect(() => {
        ...
        window.resetDarkMode = () => {
            ...
            const darkmodeLayer = document.querySelector('.darkmode-layer') as HTMLElement | null;
            const darkmodeBackground = document.querySelector('.darkmode-background') as HTMLElement | null;
            
            const isDarkModeActive = document.body.classList.contains('darkmode--activated');
            
            log.debug('Reset Dark Mode called, isDarkModeActive: ' + isDarkModeActive);
        ...
        const fixDarkModeLayer = () => {
            ...
            log.debug('Fix Dark Mode Layer called, isDarkModeActive: ' + isDarkModeActive);
